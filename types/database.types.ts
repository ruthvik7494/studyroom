...
export interface Database {
  ...
  public: {
    Tables: {
      ...
      bookings: {
        Row: {
          ...
          payment: 'unpaid' | 'paid' | 'refunded' | 'refund_pending' | 'partially_refunded' | 'failed';
          created_at: string;
    ...
    Functions: {
      ...
      reschedule_booking_group: { Args: { p_booking_group_id: string; p_new_starts_at: string }; Returns: string; };
      search_centres_by_text: { Args: { p_query: string }; Returns: { id: string }[]; };
      review_refund: { Args: { p_refund_id: string; p_approve: boolean; p_note?: string }; Returns: undefined; };
      complete_refund: { Args: { p_refund_id: string; p_razorpay_refund_id?: string }; Returns: undefined; };
      set_centre_published: { Args: { p_centre_id: string; p_published: boolean }; Returns: undefined; };
      archive_centre: { Args: { p_centre_id: string }; Returns: undefined; };
      unarchive_centre: { Args: { p_centre_id: string }; Returns: undefined; };
      admin_set_account_status: { Args: { p_user_id: string; p_status: string }; Returns: undefined; };
      admin_approve_account_deletion: { Args: { p_request_id: string }; Returns: undefined; };
      admin_reject_account_deletion: { Args: { p_request_id: string; p_notes: string }; Returns: undefined; };
      respond_to_review: { Args: { p_review_id: string; p_response: string }; Returns: undefined; };
      submit_centre_for_review: { Args: { p_centre_id: string }; Returns: undefined; };
    ...
    Enums: {
      ...
      payment_status: 'unpaid' | 'paid' | 'refunded' | 'refund_pending' | 'partially_refunded' | 'failed';
      resource_type: 'seat' | 'meeting_room' | 'conference_room' | 'cabin';
